...
## VCS
- Pregression from File backups, centralised VCS, Distributed VCS
...
# Push u1 repo master branch to the sync\centralised repo
git checkout master
...
Can now start thinking of it has an immutable database that you can query
